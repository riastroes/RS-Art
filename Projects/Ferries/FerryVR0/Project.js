...
function Project(){
  ...
  this.dokL = createVector((this.ferry.width/2)+50,this.ferryheight);
  this.dokR = createVector((this.width-50) - (this.ferry.width/2),this.ferryheight);
...
Project.prototype.checkBall = function(){
  ...
  if(abs((this.width/2) -this.ferry.pos.x) < 30){
...
Dok.prototype.construct = function(){
  ...
  beginShape();
    ...
    vertex(app.project.width-80,height/2);
  endShape(CLOSE);
    //right pier
    this.style(2);
  beginShape();
    ...
    vertex(app.project.width -100,height/2 - 10);
    vertex(app.project.width -100,height/2);
  endShape(CLOSE);
  this.style(3);
  beginShape();
    vertex(app.project.width,(height/2*2)+ 20);
    vertex(app.project.width-80,height/2 +20);
    vertex(app.project.width-100,height/2 +20);
    vertex(app.project.width-100,height/2);
    vertex(app.project.width-80,height/2);
    vertex(app.project.width,(height/2*2));
  endShape(CLOSE);
...
Ferry.prototype.construct = function(){
  ...
  this.style(4);
  beginShape();
  vertex(-50,-15);vertex(50,-15);
  vertex(50,-19);vertex(-50,-19);

  endShape(CLOSE);
  //smokepipe
  beginShape();
  vertex(-2,-19);vertex(2,-19);
...
function People(){
  ...
  this.jumping = 0;
  this.track = new Track(width, height);
...
Track.prototype.createTrackRightToBoot = function(){
  var x, y;
  y = (this.height/2)-10;
  for(x = this.width; x> this.width-80; x--){
      append(this.pos, createVector(x, y));
  }
  ...
  while(x > app.randomInt(this.width-100, this.width-50)){
    x -=10;
    append(this.pos, createVector(x, y));
  }
