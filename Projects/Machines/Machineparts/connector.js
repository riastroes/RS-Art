...
Connector.prototype.create = function() {
  ...
  //     {
        ...
        app.style.pg(this.pg[1], app.pal.colors[5], app.pal.colors[6], 1);
        this.pg[1].ellipse(this.center.x, this.center.y, this.size, this.size);
        app.style.pg(this.pg[1], false, app.pal.colors[1], 1);
        this.pg[1].ellipse(this.center.x - (this.size / 5), this.center.y - (this.size / 5), (this.size / 5), (this.size / 5));
        app.style.pg(this.pg[1], app.pal.colors[5], app.pal.colors[1], 2);
        ...
        app.style.pg(this.pg[1], app.pal.colors[1], app.pal.colors[1], 1);
    ...
    // case (this.type == 1 && !this.connected):{
      ...
      app.style.pg( this.pg[1], app.pal.colors[0], app.pal.colors[5], 1);
    ...
    // case (this.type == 2 && this.connected):{
      ...
      polygon.style(app.pal.colors[0], app.pal.colors[6], 1);
      polygon.init();
      polygon.drawpg(this.pg[3], this.center);
      app.style.pg(this.pg[3], app.pal.colors[0], app.pal.colors[3], 1);
      this.pg[3].ellipse(this.center.x, this.center.y, this.size/2, this.size/2);
    //   break;
    // }
    // case (this.type == 2 && !this.connected):{
      this.pg[4] = createGraphics(this.size, this.size);
      app.style.pg(this.pg[4], app.pal.colors[3], app.pal.colors[5], 1);
    ...
    //   {
        ...
        app.style.pg(this.pg[0], app.pal.colors[3], false, this.size/2);
